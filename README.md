...
* **quickstart**: it contains some subdirectories including examples:
  1. `API demonstration`: it contains a [jupyter notebook](https://jupyter-notebook.readthedocs.io/en/stable/index.html) to demonstrate PyRawS API.
...
Furthermore, you need to install `pyraws` through the following command in the main directory:
